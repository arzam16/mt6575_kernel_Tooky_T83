...
static bool g_enable_dvfs = true; // Zormax (original = false), false - deactivate suspend/resume CPU
...
static struct mtk_cpu_freq_info mtk_freqs_e1[] = {
    OP(DVFS_F2_MT6575_E1, 1175),
    OP(DVFS_F1_MT6575_E1, 1250),
};

static struct mtk_cpu_freq_info mtk_freqs_e2[] = {
    OP(DVFS_F4_MT6575_E2, 975),
    OP(DVFS_F3_MT6575_E2, 1075),
    OP(DVFS_F2_MT6575_E2, 1175),
    OP(DVFS_F1_MT6575_E2, 1250),
};
