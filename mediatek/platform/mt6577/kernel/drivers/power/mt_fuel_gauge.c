...
int gFG_15_vlot=BATTERY_VOLTAGE_15;
...
//4. update DOD0 after booting Xs
    if(gFG_booting_counter_I_FLAG == 1)
    {
        ...
        if( (gFG_15_vlot > 3700) || (gFG_15_vlot < 3600) ) 
        {
            xlog_printk(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] gFG_15_vlot(%d) over range, reset to BATTERY_VOLTAGE_15\r\n", gFG_15_vlot);
            gFG_15_vlot = BATTERY_VOLTAGE_15;
        }
