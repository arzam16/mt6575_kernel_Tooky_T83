...
void mt_pmic_low_power_init(void)
{
    ...
    *********************/
    ...
    {
        upmu_buck_vosel_dvs_00(BUCK_VPROC, 0x0A);
        upmu_buck_vosel_dvs_01(BUCK_VPROC, 0x0E);
        upmu_buck_vosel_dvs_10(BUCK_VPROC, 0x12);
        ...
        {
            upmu_buck_vosel_dvs_11(BUCK_VPROC, 0x15);
        }
    }
