...
const NVRAM_LENS_PARA_STRUCT OV8850AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 OV8850AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &OV8850AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pOV8850AF_getDefaultData = OV8850AF_getDefaultData;
