...
typedef struct
{
	...
	#define OV8850_IMAGE_SENSOR_FULL_HEIGHT					(2400 + 2) //(2448-48)
	...
	#define OV8850_FULL_X_START						    		(5) //(2)
	#define OV8850_FULL_Y_START						    		(5) //(2)
	#define OV8850_FULL_X_END						        	(3264) 
	#define OV8850_FULL_Y_END						        	(2448) 
	#define OV8850_PV_X_START						    		(5)
	#define OV8850_PV_Y_START						    		(5)
